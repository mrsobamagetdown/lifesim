...
# world definitions
town = World('Town', 6000, 6000, (86, 200, 76), (220, 200, 140), 100, False, False, False)
...
farm = World("Farm", 3000, 3000, (80, 220, 120), (200, 190, 70), 100, False, False, False, 0, 0.6)
	...
	def portals(self):
		if game.BUTTON1 and self.canteleport and self.touching:
			...
			if cave in self.touching:
				self.tp((0,0), caveland)
			if cave_exit in self.touching:
				self.tp(town, cave_exit, cave)
			if metro in self.touching:
				self.money -=self.tp((0,0), city, self.money, 500)
...
class Component(object):
	...
	def __init__(self, name, x ,y, width, height, color, world, showname, iscircle, textsize=30, damage=0, slip=0.2, imagename=''):
...
cave = Component('Cave', 3000,  3000, 650, 300, (190, 190, 190), town, False, False)
